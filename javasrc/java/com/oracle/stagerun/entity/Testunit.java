...
@NamedQueries({
    ...
    @NamedQuery(name = "Testunit.findById",
            query = "SELECT t FROM Testunit t WHERE t.id=:id"), 
    @NamedQuery(name = "Testunit.findByRelease",
            query = "SELECT t FROM Testunit t WHERE t.release.id=:release"),    
