...
cp  $STAGE_RUNNER_HOME/javasrc/java/META-INF/persistence.xml $STAGE_RUNNER_HOME/build/web/WEB-INF/classes/META-INF/persistence.xml
...
#sleep 10
#mv $STAGE_RUNNER_HOME/build/web/WEB-INF/classes/META-INF/persistence.xml $STAGE_RUNNER_HOME/build/web/WEB-INF/classes/META-INF/persistence1.xml
